...
var productController = new products_1.ProductController();
var index = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productController.index()];
            case 1:
                products = _a.sent();
...
var show = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var productReqId, productId, foundProduct, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                productReqId = req.params.productId;
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                productId = parseInt(productReqId);
                return [4 /*yield*/, productController.show(productId)];
            case 2:
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var productName, productPrice, actualPrice, createdProduct, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                actualPrice = parseInt(productPrice);
                return [4 /*yield*/, productController.create(productName, actualPrice)];
            case 2:
