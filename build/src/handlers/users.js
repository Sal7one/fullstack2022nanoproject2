...
var usersRoutes = function (app) {
    ...
    app.get("/users/:userId", auth_1.default, show);
...
var index = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, userController.index()];
            case 1:
                users = _a.sent();
...
var show = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userReqId, idWithoutSpaces, userId, foundUser, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                userReqId = req.params.userId;
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                idWithoutSpaces = userReqId.replace(/ /g, "");
                userId = parseInt(idWithoutSpaces);
                return [4 /*yield*/, userController.show(userId)];
            case 2:
                foundUser = _a.sent();
                if (foundUser != null)
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var firstName, lastName, password, createdUser, token, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                ...
                return [4 /*yield*/, userController.create(firstName, lastName, password)];
            case 2:
                createdUser = _a.sent();
                token = jsonwebtoken_1.default.sign({ user: createdUser }, constatns_1.JWT_SECRET);
                res.status(200)
                    .json({ token: token });
                return [3 /*break*/, 4];
            case 3:
